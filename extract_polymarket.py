...
def fetch_all_polymarket_options():
    ...
    for idx, event in enumerate(events, 1):
        ...
        if 'opinion' in event_title.lower() or 'probable' in event_title.lower() or 'opinion' in event_slug.lower() or 'probable' in event_slug.lower():
            continue
        ...
        if num_markets > 2:
            ...
            for market in markets:
                ...
                all_options.append({
                    ...
                    "slug": market.get("slug", event_slug),  # market slug for price fetching
                    "event_slug": event_slug,                 # event slug for URL
            ...
            if len(set(questions)) == 1:
                ...
                all_options.append({
                    ...
                    "slug": markets[0].get("slug", event_slug),  # market slug for price fetching
                    "event_slug": event_slug,                     # event slug for URL
                    "url": f"https://polymarket.com/event/{event_slug}",
                })
            else:
...
def main():
    ...
    # Save to file
    output_file = "polymarket_markets.json"
